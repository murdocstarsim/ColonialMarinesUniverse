    ...
    public partial class CMUBalanceRating : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    cmu_balance_rating_polls_id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    round_id = table.Column<int>(type: "INTEGER", nullable: false),
                    target = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
                    target_id = table.Column<string>(type: "TEXT", maxLength: 96, nullable: false),
                    metric = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    poll_id = table.Column<long>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cmu_balance_rating_responses_cmu_balance_rating_polls_poll_id",
                        column: x => x.poll_id,
